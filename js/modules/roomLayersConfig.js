...
const RAW = [
  { id: "ufo", mask: { i: 0, c: "r" }, tex: ufoPng },
  { id: "plane", mask: { i: 0, c: "g" }, tex: planePng },
  { id: "dino", mask: { i: 0, c: "b" }, tex: dinoPng },
  { id: "rocket", mask: { i: 1, c: "r" }, tex: rocketPng },
  { id: "robot", mask: { i: 1, c: "g" }, tex: robotPng },
  { id: "lamp", mask: { i: 1, c: "b" }, tex: lampPng },
  { id: "chess", mask: { i: 2, c: "r" }, tex: chessPng },
  { id: "car-yellow", mask: { i: 2, c: "g" }, tex: carYellowPng },
  { id: "car-green", mask: { i: 2, c: "b" }, tex: carGreenPng },
  { id: "bed", mask: { i: 3, c: "r" }, tex: bedPng },
  { id: "window", mask: { i: 3, c: "g" }, tex: windowPng },
  { id: "bookcase-2", mask: { i: 3, c: "b" }, tex: bookcase2Png },
  // Variant floor
  {
    id: "floor",
    mask: { i: 4, c: "r" },
    variants: [floor1, floor2, floor3, floor4],
    variant: true,
  },
  {
    id: "wall",
  ...
  { id: "glass-pencils", mask: { i: 6, c: "b" }, tex: glassPencilsPng },
  {
    id: "table",
    mask: { i: 7, c: "r" },
    variants: [table1, table2, table3],
    variant: true,
  },
  { id: "shelf", mask: { i: 7, c: "g" }, tex: shelfPng },
  { id: "window-light", mask: { i: 7, c: "b" }, tex: windowLightsPng },
  ...
  { id: "books-3", mask: { i: 10, c: "r" }, tex: books3Png },
  { id: "books-4", mask: { i: 10, c: "g" }, tex: books4Png },
  { id: "books-table", mask: { i: 10, c: "b" }, tex: booksTablePng },
  { id: "books-shelf", mask: { i: 24, c: "g" }, tex: booksShelfPng },
  { id: "book-floor", mask: { i: 11, c: "r" }, tex: bookFloorPng },
  { id: "goblet", mask: { i: 11, c: "g" }, tex: gobletPng },
  { id: "skates", mask: { i: 11, c: "b" }, tex: skatesPng },
  { id: "hockey", mask: { i: 12, c: "r" }, tex: hockeyPng },
  { id: "picture", mask: { i: 12, c: "g" }, tex: picturePng },
  { id: "skipping-rope", mask: { i: 12, c: "b" }, tex: skippingRopePng },
  { id: "hockey-puck", mask: { i: 13, c: "r" }, tex: hockeyPuckPng },
  { id: "ship", mask: { i: 13, c: "g" }, tex: shipPng },
  { id: "tennis-bookcase", mask: { i: 13, c: "b" }, tex: tennisBookcasePng },
  { id: "box-tennis", mask: { i: 14, c: "r" }, tex: boxTennisPng },
  { id: "tennis-shelf", mask: { i: 14, c: "g" }, tex: tennisShelfPng },
  { id: "plants", mask: { i: 14, c: "b" }, tex: plantsPng },
  { id: "football", mask: { i: 15, c: "r" }, tex: footballPng },
  { id: "tablecloth", mask: { i: 15, c: "g" }, tex: tableclothPng },
  { id: "hockey-stick", mask: { i: 15, c: "b" }, tex: hockeyStickPng },
  { id: "football-0", mask: { i: 16, c: "r" }, tex: football0Png },
  { id: "pencils-on-tha-floor", mask: { i: 16, c: "g" }, tex: pencilsFloorPng },
  { id: "cubes", mask: { i: 16, c: "b" }, tex: cubesPng },
  { id: "curtains", mask: { i: 17, c: "r" }, tex: curtainsPng },
  { id: "tennis-floor", mask: { i: 17, c: "g" }, tex: tennisFloorPng },
  { id: "picture-1", mask: { i: 17, c: "b" }, tex: picture1Png },
  { id: "picture-2", mask: { i: 18, c: "r" }, tex: picture2Png },
  { id: "car", mask: { i: 18, c: "g" }, tex: carPng },
  { id: "posters", mask: { i: 18, c: "b" }, tex: postersPng },
  { id: "picture-sh", mask: { i: 19, c: "r" }, tex: pictureShPng },
  { id: "stickers", mask: { i: 19, c: "g" }, tex: stickersPng },
  { id: "tennis-racket", mask: { i: 19, c: "b" }, tex: tennisRacketPng },
  { id: "sh-walls", mask: { i: 20, c: "r" }, tex: shWallsPng },
  { id: "sh-bed", mask: { i: 21, c: "r" }, tex: shBedPng },
  { id: "sh-bed-2", mask: { i: 22, c: "r" }, tex: shBed2Png },
  { id: "bookcase", mask: { i: 22, c: "g" }, tex: bookcasePng },
