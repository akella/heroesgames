...
export class OverlayObjectsManager {
  ...
  add(cfg) {
    ...
    el.style.top =
      typeof initial.y === "number" ? initial.y + "px" : initial.y || "10%";
    el.style.left =
      typeof initial.x === "number" ? initial.x + "px" : initial.x || "10%";
    ...
    const record = {
      ...
      imgHover,
      action,
      parallax: Object.assign(
        { strengthX: 25, strengthY: 25, lerp: 0.1 },
        parallax
      ),
      ...
      centerOffset:
        initial.centerOffset &&
        typeof initial.centerOffset.x === "number" &&
        typeof initial.centerOffset.y === "number"
          ? {
